...
class Sand {
    ...
    private static final float[] HEIGHTS = {SAND_HEIGHT,SAND_HEIGHT +0.01f,SAND_HEIGHT-0.05f,SAND_HEIGHT-0.07f,SAND_HEIGHT+0.02f,
            SAND_HEIGHT-0.03f,SAND_HEIGHT+0.02f,SAND_HEIGHT+0.07f,SAND_HEIGHT+0.02f,SAND_HEIGHT};
